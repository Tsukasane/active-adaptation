...
from isaaclab.utils.math import quat_mul, quat_conjugate, axis_angle_from_quat, wrap_to_pi


TrackBoxTermination = BaseTermination["MotionTrackingBox"]

class cum_box_pos_error(_cum_error):
...
class cum_box_ori_error(_cum_error):
    command_manager: "MotionTrackingBox"
    def update(self):
...
class cum_lost_contact_steps(_cum_error):
    command_manager: "MotionTrackingBox"
